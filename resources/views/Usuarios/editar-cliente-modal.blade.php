    ...
    <div class="row">
        ...
        <div class="col-sm-6">    
            <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nombre" class="form-control" id="apellidos"  ng-model="$ctrl.apellidos" ng-minlength="2" ng-maxlength="20" placeholder="Apellidos cliente" required="required">
