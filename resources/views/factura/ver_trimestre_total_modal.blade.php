...
<div class="modal-header">
 ...
 <div class="modal-body " id="modal-body" >
 	<p style="font-size: 17px;" ng-if="$ctrl.trimestre_total_facturas.length == 0">No se han encontrado registros</p>
      <div class="table-responsive" ng-if="$ctrl.trimestre_total_facturas.length > 0">
		  <table class="table"  st-table="trimestre" st-safe-src="$ctrl.trimestre_total_facturas">
		        <thead>
		        	<tr>
